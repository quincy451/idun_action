...
3. Keep shared Action source, OBJ1 records, link-selected 6502 runtime behavior,
   ...
   Native named-REAL `FSign`, `FTrunc`, `FFloor`, `FCeil`, `FRound`, `FFrac`, `FMod`, `FHypot`, `FExp`, `FLn`, `FLog2`, `FLog10`, `FMin`, and `FMax` calls plus its bounded
   ...
   `FHypot`, `FExp`, `FLn`, `FLog2`, `FLog10`, `FMin`, and `FMax` to the same shared objects instead of embedding
