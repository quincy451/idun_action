...
SRC="$SRC_DIR/actdbg_overlay_exec.asm"
CFG="$SRC_DIR/actdbg_overlay.cfg"
OBJ="$BUILD_DIR/actdbg_overlay_exec.o"
BIN="$BUILD_DIR/ACTDBG_OVL2.BIN"
LABELS="$BUILD_DIR/actdbg_overlay_exec.labels"
MAP="$BUILD_DIR/actdbg_overlay_exec.map"
