...
SRC="$SRC_DIR/avmrun_overlay_printreal.asm"
CFG="$SRC_DIR/avmrun_overlay.cfg"
OBJ="$BUILD_DIR/avmrun_overlay_printreal.o"
BIN="$BUILD_DIR/AVMRUN_OVL1.BIN"
LABELS="$BUILD_DIR/avmrun_overlay_printreal.labels"
MAP="$BUILD_DIR/avmrun_overlay_printreal.map"
