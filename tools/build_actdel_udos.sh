...
SRC="$ROOT_DIR/src/tools_udos/actdel/actdel.asm"
CFG="$ROOT_DIR/src/tools_udos/actdel/actdel.cfg"
...
OBJ="$BUILD_DIR/actdel.o"
BIN="$BUILD_DIR/actdel.bin"
PRG="$BUILD_DIR/ACTDEL.PRG"
