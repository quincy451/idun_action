...
SRC="$ROOT_DIR/src/tools_udos/actsrc/actsrc.asm"
CFG="$ROOT_DIR/src/tools_udos/actsrc/actsrc.cfg"
...
OBJ="$BUILD_DIR/actsrc.o"
BIN="$BUILD_DIR/actsrc.bin"
PRG="$BUILD_DIR/ACTSRC.PRG"
