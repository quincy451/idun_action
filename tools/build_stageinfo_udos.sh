...
SRC="$ROOT_DIR/src/tools_udos/stageinfo/stageinfo.asm"
CFG="$ROOT_DIR/src/tools_udos/stageinfo/stageinfo.cfg"
...
OBJ="$BUILD_DIR/stageinfo.o"
BIN="$BUILD_DIR/stageinfo.bin"
PRG="$BUILD_DIR/STAGEINFO.PRG"
