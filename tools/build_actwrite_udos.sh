...
SRC="$ROOT_DIR/src/tools_udos/actwrite/actwrite.asm"
CFG="$ROOT_DIR/src/tools_udos/actwrite/actwrite.cfg"
...
OBJ="$BUILD_DIR/actwrite.o"
BIN="$BUILD_DIR/actwrite.bin"
PRG="$BUILD_DIR/ACTWRITE.PRG"
