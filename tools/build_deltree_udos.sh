...
SRC="$ROOT_DIR/src/tools_udos/deltree/deltree.asm"
CFG="$ROOT_DIR/src/tools_udos/deltree/deltree.cfg"
...
OBJ="$BUILD_DIR/deltree.o"
BIN="$BUILD_DIR/deltree.bin"
OVERLAY="$BUILD_DIR/DELTREE.OVL"
