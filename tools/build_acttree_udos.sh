...
SRC="$ROOT_DIR/src/tools_udos/acttree/acttree.asm"
CFG="$ROOT_DIR/src/tools_udos/acttree/acttree.cfg"
...
OBJ="$BUILD_DIR/acttree.o"
BIN="$BUILD_DIR/acttree.bin"
OVERLAY="$BUILD_DIR/TREE.OVL"
