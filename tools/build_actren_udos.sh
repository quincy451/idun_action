...
SRC="$ROOT_DIR/src/tools_udos/actren/actren.asm"
CFG="$ROOT_DIR/src/tools_udos/actren/actren.cfg"
...
OBJ="$BUILD_DIR/actren.o"
BIN="$BUILD_DIR/actren.bin"
PRG="$BUILD_DIR/ACTMOVE.PRG"
