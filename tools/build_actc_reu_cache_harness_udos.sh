...
ACTC_PREALLOCATE_BODY_EXTERNALS="${ACTC_PREALLOCATE_BODY_EXTERNALS:-0}"
ACTC_PREALLOCATE_BODY_EXTERNALS_IN_OVERLAY="${ACTC_PREALLOCATE_BODY_EXTERNALS_IN_OVERLAY:-0}"
...
ca65 -g \
  ...
  -D "ACTC_PREALLOCATE_BODY_EXTERNALS=$ACTC_PREALLOCATE_BODY_EXTERNALS" \
  -D "ACTC_PREALLOCATE_BODY_EXTERNALS_IN_OVERLAY=$ACTC_PREALLOCATE_BODY_EXTERNALS_IN_OVERLAY" \
  -D STREAM_OUTPUT=1 \
