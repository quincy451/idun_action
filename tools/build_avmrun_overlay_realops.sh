...
SRC="$SRC_DIR/avmrun_overlay_realops.asm"
CFG="$SRC_DIR/avmrun_overlay.cfg"
OBJ="$BUILD_DIR/avmrun_overlay_realops.o"
BIN="$BUILD_DIR/AVMRUN_OVL2.BIN"
LABELS="$BUILD_DIR/avmrun_overlay_realops.labels"
MAP="$BUILD_DIR/avmrun_overlay_realops.map"
