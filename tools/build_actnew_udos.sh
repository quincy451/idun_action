...
SRC="$ROOT_DIR/src/tools_udos/actnew/actnew.asm"
CFG="$ROOT_DIR/src/tools_udos/actnew/actnew.cfg"
...
OBJ="$BUILD_DIR/actnew.o"
BIN="$BUILD_DIR/actnew.bin"
PRG="$BUILD_DIR/ACTNEW.PRG"
