...
SRC="$SRC_DIR/avmrun_native_helper_printstd.asm"
CFG="$SRC_DIR/avmrun_native_helper_std.cfg"
OBJ="$BUILD_DIR/avmrun_native_helper_printstd.o"
BIN="$BUILD_DIR/RT_PRINT_STD_HELPER.BIN"
LABELS="$BUILD_DIR/avmrun_native_helper_printstd.labels"
MAP="$BUILD_DIR/avmrun_native_helper_printstd.map"
