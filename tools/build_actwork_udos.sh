...
SRC="$ROOT_DIR/src/tools_udos/actwork/actwork.asm"
CFG="$ROOT_DIR/src/tools_udos/actwork/actwork.cfg"
...
OBJ="$BUILD_DIR/actwork.o"
BIN="$BUILD_DIR/actwork.bin"
PRG="$BUILD_DIR/ACTWORK.PRG"
