...
SRC="$ROOT_DIR/src/tools_udos/actcopy/actcopy.asm"
CFG="$ROOT_DIR/src/tools_udos/actcopy/actcopy.cfg"
...
OBJ="$BUILD_DIR/actcopy.o"
BIN="$BUILD_DIR/actcopy.bin"
PRG="$BUILD_DIR/ACTCOPY.PRG"
