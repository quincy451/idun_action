...
SRC="$ROOT_DIR/src/tools_udos/actadd/actadd.asm"
CFG="$ROOT_DIR/src/tools_udos/actadd/actadd.cfg"
...
OBJ="$BUILD_DIR/actadd.o"
BIN="$BUILD_DIR/actadd.bin"
PRG="$BUILD_DIR/ACTADD.PRG"
