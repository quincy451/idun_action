...
SRC="$ROOT_DIR/src/tools_udos/actchk/actchk.asm"
CFG="$ROOT_DIR/src/tools_udos/actchk/actchk.cfg"
...
OBJ="$BUILD_DIR/actchk.o"
BIN="$BUILD_DIR/actchk.bin"
PRG="$BUILD_DIR/ACTCHK.PRG"
