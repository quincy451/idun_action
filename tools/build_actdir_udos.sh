...
SRC="$ROOT_DIR/src/tools_udos/actdir/actdir.asm"
CFG="$ROOT_DIR/src/tools_udos/actdir/actdir.cfg"
...
OBJ="$BUILD_DIR/actdir.o"
BIN="$BUILD_DIR/actdir.bin"
PRG="$BUILD_DIR/ACTDIR.PRG"
