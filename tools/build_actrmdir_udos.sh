...
SRC="$ROOT_DIR/src/tools_udos/actrmdir/actrmdir.asm"
CFG="$ROOT_DIR/src/tools_udos/actrmdir/actrmdir.cfg"
...
OBJ="$BUILD_DIR/actrmdir.o"
BIN="$BUILD_DIR/actrmdir.bin"
PRG="$BUILD_DIR/ACTRMDIR.PRG"
