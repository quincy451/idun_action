...
SRC="$ROOT_DIR/src/tools_udos/actmkdir/actmkdir.asm"
CFG="$ROOT_DIR/src/tools_udos/actmkdir/actmkdir.cfg"
...
OBJ="$BUILD_DIR/actmkdir.o"
BIN="$BUILD_DIR/actmkdir.bin"
PRG="$BUILD_DIR/ACTMKDIR.PRG"
