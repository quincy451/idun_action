...
ca65 -g -D SOURCE_LIMIT=511 -D BODY_OPS_STRIDE=160 -D INT_LITERAL_MAX=36 -D STRING_LITERAL_MAX=36 -D EXPORT_MAX=16 -D EXTERNAL_MAX=16 -D LOOP_MAX=16 -o "$OBJ" "$SRC" -I "$BUILD_DIR"
