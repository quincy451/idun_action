...
clear_state:
    ...
    sta actdbg_avm_stage_len_lo
    sta actdbg_avm_stage_len_hi
    sta actdbg_avm_stage_len_bank
...
build_exact_paths:
    ...
    ldy #>arg_buffer
    jsr copy_const_to_ptr
    jsr derive_dbg_path_from_avm
    jsr derive_project_root_from_avm
    rts
...
load_avm_stage_ok:
    ...
    lda #ACTDBG_AVM_REU_BASE_BANK
    sta file_params+2
    lda #<actdbg_avm_header
    sta file_params+3
    lda #>actdbg_avm_header
    sta file_params+4
    lda #AVM_HEADER_LIMIT
    sta file_params+5
    lda #$00
    sta file_params+6
    sta file_params+7
...
derive_project_root_from_avm:
    lda #$00
    sta actdbg_project_root
    ldy #$00
    sty status_ptr
copy_parent_scan:
    lda actdbg_avm_path,y
...
msg_usage:
    .asciiz "ACTDBG PROG OR PROG.AVM"
msg_no_avm:
    .asciiz "NO AVM"
msg_bad_avm:
    .asciiz "BAD AVM"
...
locals_prefix:
    .asciiz "L: "
help_line:
    .asciiz "F3/F4/F5/F6 F7 B T Q ARROWS"
prefix_bin:
    .asciiz "BIN/"
suffix_avm:
    .asciiz ".AVM"
...
actdbg_room_check_hi:
    .res 1
actdbg_avm_stage_len_lo:
    .res 1
actdbg_avm_stage_len_hi:
    .res 1
actdbg_avm_stage_len_bank:
    .res 1
...
actdbg_step_mode:
    .res 1
actdbg_step_target_rsp:
    .res 1
actdbg_step_target_pc_lo:
    .res 1
actdbg_step_target_pc_hi:
    .res 1
actdbg_vm_header_len:
    .res 1
actdbg_avm_header:
    .res AVM_HEADER_LIMIT
actdbg_vm_fetch_buffer:
    .res 3
actdbg_file_window:
    .res ACTDBG_FILE_WINDOW_LIMIT
actdbg_vm_payload_lo:
    .res 1
actdbg_vm_payload_hi:
    .res 1
actdbg_vm_payload_bank:
    .res 1
actdbg_vm_payload_len_lo:
    .res 1
actdbg_vm_payload_len_hi:
    .res 1
actdbg_vm_scan_lo:
    .res 1
actdbg_vm_scan_hi:
    .res 1
actdbg_vm_scan_end_lo:
    .res 1
actdbg_vm_scan_end_hi:
    .res 1
actdbg_vm_entry_lo:
    .res 1
actdbg_vm_entry_hi:
