...
class TestToolAbiPipeline(unittest.TestCase):
    ...
    def test_real_add_assignment_runtime_pipeline_is_green_under_harness(self) -> None:
        self.run_scenario("real_add_assignment_runtime", "FADD\nDONE\n", 90, 77)
    ...
    def test_digit_symbol_names_pipeline_is_green_under_harness(self) -> None:
        self.run_scenario("digit_symbol_names", "1\n2\n6\n", 111, 69)
    ...
    def test_loop9_do_until_pipeline_is_green_under_harness(self) -> None:
        self.run_scenario("loop9_do_until", "DEEP\n", 185, 116)

    def test_loop9_while_pipeline_is_green_under_harness(self) -> None:
        self.run_scenario("loop9_while", "DONE\n", 194, 153)

    def test_string36_high_index_pipeline_is_green_under_harness(self) -> None:
        self.run_scenario("string36_high_index", "Z\n", 263, 23)
    ...
    def test_payload265_local_calls_pipeline_is_green_under_harness(self) -> None:
        self.run_scenario("payload265_local_calls", "77\n", 221, 265)
    ...
    def test_proc259_dead_printi_var_pipeline_is_green_under_harness(self) -> None:
        self.run_scenario("proc259_dead_printi_var", "OK\n", 191, 26)
