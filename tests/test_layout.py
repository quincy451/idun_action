...
class TestRepoLayout(unittest.TestCase):
    def test_repo_layout_smoke(self) -> None:
        ...
        required = [
            ...
            "src/runtime/udos_modules/rt_f_sub.avo",
            "src/runtime/udos_modules/rt_f_mul.avo",
            "src/runtime/udos_modules/rt_f_div.avo",
            "src/runtime/udos_modules/rt_print_f.avo",
            "src/tools_cpm",
            "src/tools_cpm/alink",
            ...
            "examples/filecopy_runtime.avm.txt",
            ...
            "tests/test_vmrun_file_io.py",
            "tests/test_alink_on_target.py",
            "tests/test_vmrun_reu_runtime.py",
            "tests/test_compile_and_run.py",
            "tests/test_actc_bundle_on_target.py",
