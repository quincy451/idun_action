...
class TestActcReuSourceCache(unittest.TestCase):
    ...
    def test_runtime_sum_operators_use_expected_char_helper(self) -> None:
        actc_path = self.root / "src" / "tools_udos" / "actc" / "actc.asm"
        actc_text = actc_path.read_text(encoding="ascii")
        match = re.search(
    ...
    def test_small_value_punctuation_uses_expected_char_helper(self) -> None:
        actc_path = self.root / "src" / "tools_udos" / "actc" / "actc.asm"
        actc_text = actc_path.read_text(encoding="ascii")
        match = re.search(
    ...
    def test_small_bool_group_punctuation_uses_expected_char_helper(self) -> None:
        actc_path = self.root / "src" / "tools_udos" / "actc" / "actc.asm"
        actc_text = actc_path.read_text(encoding="ascii")
        match = re.search(
    ...
    def test_small_condition_operators_use_expected_char_helper(self) -> None:
        actc_path = self.root / "src" / "tools_udos" / "actc" / "actc.asm"
        actc_text = actc_path.read_text(encoding="ascii")
        match = re.search(
            r"parse_small_condition_clause_at_scan_y:\n(?P<body>.*?)\n"
            r"parse_small_decimal_expr_at_scan_y:",
            actc_text,
            re.DOTALL,
        )
        self.assertIsNotNone(match)
    ...
    def test_small_decimal_expr_operators_use_expected_char_helper(self) -> None:
        actc_path = self.root / "src" / "tools_udos" / "actc" / "actc.asm"
        actc_text = actc_path.read_text(encoding="ascii")
        match = re.search(
            r"parse_small_decimal_expr_at_scan_y:\n(?P<body>.*?)\n"
    ...
    def test_small_decimal_arithmetic_operators_use_expected_char_helper(self) -> None:
        actc_path = self.root / "src" / "tools_udos" / "actc" / "actc.asm"
        actc_text = actc_path.read_text(encoding="ascii")
        ranges = {
    ...
    def test_small_decimal_group_punctuation_uses_expected_char_helper(self) -> None:
        actc_path = self.root / "src" / "tools_udos" / "actc" / "actc.asm"
        actc_text = actc_path.read_text(encoding="ascii")
        match = re.search(
    ...
    def test_runtime_real_bridge_close_paren_uses_expected_char_helper(self) -> None:
        actc_path = self.root / "src" / "tools_udos" / "actc" / "actc.asm"
        actc_text = actc_path.read_text(encoding="ascii")
        match = re.search(
    ...
    def test_runtime_real_condition_operators_use_expected_char_helper(self) -> None:
        actc_path = self.root / "src" / "tools_udos" / "actc" / "actc.asm"
        actc_text = actc_path.read_text(encoding="ascii")
        match = re.search(
    ...
    def test_runtime_condition_operators_use_expected_char_helper(self) -> None:
        actc_path = self.root / "src" / "tools_udos" / "actc" / "actc.asm"
        actc_text = actc_path.read_text(encoding="ascii")
        match = re.search(
            r"emit_runtime_condition_clause_from_scan_y_or_fail:\n(?P<body>.*?)\n"
