...
class TestIdunForkLayout(unittest.TestCase):
    ...
    def test_cross_product_plan_tracks_native_real_progress_and_remaining_work(self) -> None:
        ...
        self.assertIn("inventories are 1,359 broad direct-PRG shapes", flat_parity)
        self.assertIn("191 non-runtime source-backed object-emission shapes", flat_parity)
        ...
        self.assertIn("844 native ActionC64U unittests", parity)
        ...
        self.assertIn("237-test overlay suite and 198-test source-cache suite", parity)
        ...
        self.assertIn("complete ACTC compiler, passes 0 through Q", parity)
        ...
        self.assertIn("Current native inventories are 1,359 broad", flat_handoff)
        self.assertIn("191 non-runtime source-backed", flat_handoff)
