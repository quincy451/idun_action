...
class TestIdunForkLayout(unittest.TestCase):
    ...
    def test_cross_product_plan_tracks_native_real_progress_and_remaining_work(self) -> None:
        ...
        self.assertIn("1,339 broad", parity)
        self.assertIn("173 non-runtime source-backed object-emission shapes", parity)
        self.assertIn("296 compiled-runtime relocation-oracle cases", parity)
        self.assertIn("thirteen link-selected callable builtins", parity)
        self.assertIn("remaining 30 MATH1 routines", parity)
