...
class TestIdunForkLayout(unittest.TestCase):
    ...
    def test_cross_product_plan_tracks_native_real_progress_and_remaining_work(self) -> None:
        ...
        self.assertIn("inventories are 1,362 broad direct-PRG shapes", flat_parity)
        self.assertIn("194 non-runtime source-backed object-emission shapes", flat_parity)
        ...
        self.assertIn("854 native ActionC64U unittests", parity)
        ...
        self.assertIn("244-test overlay suite and 198-test source-cache suite", parity)
        ...
        self.assertIn("complete ACTC compiler, passes 0 through T", parity)
        ...
        self.assertIn("Current native inventories are 1,362 broad", flat_handoff)
        self.assertIn("194 non-runtime source-backed", flat_handoff)
