...
class TestIdunForkLayout(unittest.TestCase):
    ...
    def test_cross_product_plan_tracks_native_real_progress_and_remaining_work(self) -> None:
        ...
        self.assertIn("inventories are 1,365 broad direct-PRG shapes", flat_parity)
        self.assertIn("195 non-runtime source-backed object-emission shapes", flat_parity)
        ...
        self.assertIn("860 native ActionC64U unittests", parity)
        ...
        self.assertIn("248-test overlay suite and 198-test source-cache suite", parity)
        ...
        self.assertIn("Pass U is 6,514 bytes with 1,678 bytes free", flat_parity)
        ...
        self.assertIn("Current native inventories are 1,365 broad", flat_handoff)
        self.assertIn("195 non-runtime source-backed", flat_handoff)
