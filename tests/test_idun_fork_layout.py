...
class TestIdunForkLayout(unittest.TestCase):
    ...
    def test_cross_product_plan_tracks_native_real_progress_and_remaining_work(self) -> None:
        ...
        self.assertIn("1,331 shapes", parity)
        self.assertIn("source-backed object-emission inventory remains 171 shapes", parity)
        self.assertIn("compiled-runtime relocation oracle covers 290 cases", parity)
        self.assertIn("793 native ActionC64U unittests", parity)
        ...
        self.assertIn("204-test overlay suite and 198-test source-cache suite", parity)
