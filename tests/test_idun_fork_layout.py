...
class TestIdunForkLayout(unittest.TestCase):
    ...
    def test_cross_product_plan_tracks_native_real_progress_and_remaining_work(self) -> None:
        ...
        self.assertIn("1,333 broad", parity)
        self.assertIn("172 non-runtime source-backed object-emission shapes", parity)
        self.assertIn("relocation oracle covers 291 cases", parity)
        self.assertIn("796 native ActionC64U unittests", parity)
        ...
        self.assertIn("208-test overlay suite and 198-test source-cache suite", parity)
