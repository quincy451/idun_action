...
class TestIdunForkLayout(unittest.TestCase):
    ...
    def test_cross_product_plan_tracks_native_real_progress_and_remaining_work(self) -> None:
        ...
        self.assertIn("inventories are 1,348 broad direct-PRG shapes", flat_parity)
        self.assertIn("180 non-runtime source-backed object-emission shapes", flat_parity)
        ...
        self.assertIn("814 native ActionC64U unittests", parity)
        ...
        self.assertIn("Current native inventories are 1,348 broad", flat_handoff)
        self.assertIn("180 non-runtime source-backed", flat_handoff)
