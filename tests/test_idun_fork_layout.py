...
class TestIdunForkLayout(unittest.TestCase):
    ...
    def test_cross_product_plan_tracks_native_real_progress_and_remaining_work(self) -> None:
        ...
        self.assertIn("1,332 shapes", parity)
        self.assertIn("object-emission inventory remains 171 shapes", parity)
        self.assertIn("relocation oracle covers 291 cases", parity)
        self.assertIn("794 native ActionC64U unittests", parity)
        ...
        self.assertIn("207-test overlay suite and 198-test source-cache suite", parity)
