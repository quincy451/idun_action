...
class TestIdunForkLayout(unittest.TestCase):
    ...
    def test_cross_product_plan_tracks_native_real_progress_and_remaining_work(self) -> None:
        ...
        self.assertIn("1,334 broad", parity)
        ...
        self.assertIn("798 native ActionC64U unittests", parity)
        ...
        self.assertIn("209-test overlay suite and 198-test source-cache suite", parity)
